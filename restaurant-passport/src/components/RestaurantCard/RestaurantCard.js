...
const RestaurantCard = ({restaurant}) => {
    ...
    //fake data
    const [restaurantData, setRestaurantData] = useState([{user_id: "2", restaurant_id: "1", stamped : true, notes: "It was great", myRating: "3"}, {user_id: "2", restaurant_id: "1", stamped : false, notes: "It was great", myRating: "5"}]);
    ...
    return (
        <div className="rest_card">
            ...
            <div className="img_container">
                ...
                {restaurant && <img className="rest_img" src={restaurant.restaurantPictureURL} alt={restaurant.restaurantName} />}
            ...
            <div className="rest_info">
                ...
                <div className="rating_container">Rating:
                    <span className="rating">
                        {avgRating>= .5? <FaStar className="gold"/>: <FaStar/>}
